        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col">
                        <a href="dashboard.php" class = "link-primary">Home</span></a> > <a href="subject.php" class="link-success">Subject</span></a>
                        </div>
                    </div>
                </div>
            </nav>
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td class = "text-center">
                                                                <button type="button" class = "ups bg-warning p-2 border border-5 text-dark" data-id="'.$id.'" data-subject="'.$subject.'" data-description="'.$description.'" data-color="'.$color.'">Edit</button>
...
<script type="text/javascript">
    $(document).on('submit', '#manage-subject', function(){
        // alert("dasdadasda");  
    $.post('create_subject.php', $(this).serialize(), function(data){
    ...
    $(document).ready(function () { 
        ...
        $('.ups').click(function(){
            ...
            var sob = $(this).attr('data-subject');
            var des = $(this).attr('data-description');
            var kol = $(this).attr('data-color');
            // 
            $("#id").val(eydi);
            $("#subject").val(sob);
