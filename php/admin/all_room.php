    ...
    if($resultz){
        while($rowz = mysqli_fetch_assoc($resultz)){
            ...
            echo'
                <div class = row>
                    <div class = "col-6">
                        <p style = "margin:0;"><b>Room Id: </b>'.$rrc.'</p>
                        <p style = "margin:0;"><b>Name: </b>'.$roo.'</p>
                    </div>
                    <div class = "col-6">
                </div>
            ';
                    ...
                    <table class="table table-striped mb-5 border border-5" id = "table-user" style = "font-size:10px;">
                        ...
                        if($result){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                $fc= " ";
                                //monday
                                $sqlm = "SELECT * from `schedule` WHERE `time` = $t_id AND `room` = $rrc AND `day` = 1;";
                                ...
                                //tuesday
                                $sqlt = "SELECT * from `schedule` WHERE `time` = $t_id AND `room` = $rrc AND `day` = 2;";
                                ...
                                //wednesday
                                $sqlw = "SELECT * from `schedule` WHERE `time` = $t_id AND `room` = $rrc AND `day` = 3;";
                                ...
                                //thursday
                                $sqlth = "SELECT * from `schedule` WHERE `time` = $t_id AND `room` = $rrc AND `day` = 4;";
                                ...
                                $sqlf = "SELECT * from `schedule` WHERE `time` = $t_id AND `room` = $rrc AND `day` = 5;";
