                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td class = "text-center">
                                                                <button type="button" class = "ups bg-warning p-2 border border-5 text-dark" data-id="'.$id.'" data-room="'.$room.'" data-description="'.$description.'">Edit</button>
...
<script type="text/javascript">
    $(document).on('submit', '#manage-room', function(){
        // alert("dasdadasda");  
    $.post('create_room.php', $(this).serialize(), function(data){
