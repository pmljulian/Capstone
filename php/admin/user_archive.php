        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col">
                        <a href="dashboard.php" class = "link-primary">Home</span></a> > <a href="user_archive.php" class="link-success">Archived Users</span></a>
                        </div>
                    </div>
                </div>
            </nav>
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<tbody>
                                <?php
                                    include '../connect.php';
                                    //get data
                                    $sql = "SELECT * from `users` WHERE `archive` = 'YES'";
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td class = "text-center">
                                                            ...
                                                            <button type="button" class = "mem bg-success p-2 border border-5 text-dark" id = "'.$id.'">Activate</button>
                                                        </td>
                                                    </tr>
                                                ';
                                            }
      ...
      <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-4 text-left">
                    ...
                    <input type="number" class="form-control" id="Input5" name="Input5" placeholder="+63 / 09" placeholder="+63 / 09" min = "1000000000" max = "9999999999" required>
                </div>
                <div class="col-4 text-left">
...
<div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <label>Are you sure that you want to activate?</label>
      </div>
      <div class="modal-footer">
      <button type="submit" class="btn btn-success" id = "com">Yes</button>
